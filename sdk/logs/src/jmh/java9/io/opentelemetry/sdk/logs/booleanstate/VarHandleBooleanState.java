...
public class VarHandleBooleanState implements BooleanState {
  ...
  static {
    try {
      ...
      STATE_HANDLE = lookup.findVarHandle(VarHandleBooleanState.class, "state", boolean.class);

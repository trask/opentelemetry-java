...
public class BooleanStateBenchmark {
  ...
  @Param({
    ...
    "VolatileBooleanState",
    "EventualBooleanState",
    "VarHandleBooleanState", // available with -PjmhJavaVersion=11 and higher
  ...
  public void setup() {
    switch (implementation) {
      case "NonVolatileBooleanState":
        ...
        break;
      case "VolatileBooleanState":
        state = new VolatileBooleanState();
        break;
      case "EventualBooleanState":
        state = new EventualBooleanState();
        break;
      case "VarHandleBooleanState":
        state = createVarHandleBooleanState();
        break;
  ...
  private static BooleanState createVarHandleBooleanState() {
    try {
      Class<?> clazz =
          Class.forName("io.opentelemetry.sdk.logs.booleanstate.VarHandleBooleanState");
      return (BooleanState) clazz.getConstructor().newInstance();
    } catch (Exception e) {
      throw new IllegalStateException(
          "VarHandleBooleanState not available on this Java version", e);
    }
  }
